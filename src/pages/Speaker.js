...
import UploadFile from "./components/Speaker/UploadFile";
import LiveVideo from "./components/Speaker/LiveVedio";
  ...
  return(
    <>
      ...
      <main className=" text-black align-middle font-bold text-2xl p-10 h-auto">
        <h1 className="text-center text-3xl">Hello <span className="text-orange-400">Speaker</span>,
